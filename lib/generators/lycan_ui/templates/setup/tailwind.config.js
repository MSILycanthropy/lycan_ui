...
module.exports = {
  ...
  theme: {
    extend: {
      boxShadow: {
        'switch': '-1rem 0 0 0.125rem hsl(var(--color-secondary)) inset, 0 0 0 0.125rem hsl(var(--color-secondary)) inset',
        'switch-checked': '1rem 0 0 0.125rem hsl(var(--color-accent)) inset, 0 0 0 0.125rem hsl(var(--color-accent)) inset',
      },
      colors: {
        ...
        accent: {
          ...
          '500': 'hsl(var(--color-accent-500))', // light
        ...
        danger: {
          ...
          '600': 'hsl(var(--color-danger-600))', // dark
          '700': 'hsl(var(--color-danger-700))', // light
